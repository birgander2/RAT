...
; RAT - Radar Tools
;------------------------------------------------------------------------
; RAT Module: decomp_eigendual
; written by    : Tisham Dhar
; last revision : 23.September.2008
; Calculates dual-pol eigenvalue and eigenvectors
;------------------------------------------------------------------------
...
pro decomp_tvsm,CALLED=called,SMM=smm
...
; check if array is usable
	...
	if not keyword_set(called) then begin             ; Graphical interface
		main = WIDGET_BASE(GROUP_LEADER=wid.base,row=3,TITLE='TVSM decomposition',/floating,/tlb_kill_request_events,/tlb_frame_attr)
		...
		repeat begin                                        ; Event loop
			...
			if event.id eq but_info then begin               ; Info Button clicked
				infotext = ['TVSM DECOMPOSITION',$
				' ',$
				'RAT module written 09/2008 by Tisham Dhar']
...
; pop up progress window
	...
	progress,Message='TVSM Decomposition...',/cancel_button
