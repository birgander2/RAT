; docformat = 'rst'
;+
; Opens a file in F-SAR DCSLC format
;
; :Keywords:
...
; All Rights Reserved.
;-
pro open_fsardcslc,INPUTFILE = inputfile
   ...
   if not keyword_set(inputfile) then begin
      path = config.workdir
      inputfile = cw_rat_dialog_pickfile(TITLE='Open F-SAR DCSLC file', $
...
; converting Rolf's format to RAT
      ...
      srat,outputfile,eee,header=[2l,anzx,anzy,6l],type=101l
      ...
      progress,message='Reading F-SAR DCSLC file...'
...
; read header
      ...
      head = 1l
      rrat,outputfile,ins1,header=head,info=info
      free_lun,ins1
